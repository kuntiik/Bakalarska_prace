...
\ctutemplateset{titlepage}{
	...
	\vss%
    %TODO revertu to 11,11pt
	{\noindent\leavevmode\color{ctubluerule}\vrule width 9pt\hspace*{8pt}}
...
\ctutemplateset{include.specification}{
    ...
    %\includepdf{~/uprava_bp/pictures/zadani.pdf}
}
